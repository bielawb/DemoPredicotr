...
namespace PowerShell.NET.PL {
    public class DemoPredictor : ICommandPredictor
    {
        ...
        /// </summary>
        public string Name => "DemoPredictor";

        /// <summary>
        /// Gets the description of a subsystem implementation.
        /// </summary>
        public string Description => "Demo Predictor for PSConfEU";
    ...
    {
        private const string Identifier = "1680fd3c-3fee-4574-8c0c-8ff7c3114f7a";
        ...
        {
            var predictor = new DemoPredictor(Identifier);
